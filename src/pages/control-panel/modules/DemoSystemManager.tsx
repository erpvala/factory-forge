...
export default function DemoSystemManager() {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Monitor className="w-8 h-8 text-primary" />
        <div>
          <h1 className="text-2xl font-bold text-foreground">Demo System Manager</h1>
          <p className="text-sm text-muted-foreground">Demo infrastructure management</p>
        </div>
      </div>
