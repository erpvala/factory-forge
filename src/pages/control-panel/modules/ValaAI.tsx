...
export default function ValaAI() {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Brain className="w-8 h-8 text-primary" />
        <div>
          <h1 className="text-2xl font-bold text-foreground">VALA AI</h1>
          <p className="text-sm text-muted-foreground">Autonomous AI engine control</p>
        </div>
      </div>
