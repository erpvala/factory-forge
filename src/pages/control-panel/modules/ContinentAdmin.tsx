...
export default function ContinentAdmin() {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Globe className="w-8 h-8 text-primary" />
        <div>
          <h1 className="text-2xl font-bold text-foreground">Continent Admin</h1>
          <p className="text-sm text-muted-foreground">Continental operations oversight</p>
        </div>
      </div>
