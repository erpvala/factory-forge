...
import { Shield, Wifi, WifiOff, Bell, Settings, LogOut, Activity, AlertTriangle, RefreshCw, Check, ChevronDown, LayoutGrid } from 'lucide-react';
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={switcherRef}>
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-semibold text-white/80 hover:text-white"
          ...
          {switcherOpen && (
            <div
              className="absolute right-0 mt-2 w-72 rounded-lg shadow-2xl overflow-hidden z-50"
              style={{ background: '#0f1c33', border: '1px solid rgba(255,255,255,0.12)' }}
            >
              <div className="px-4 py-2.5 border-b border-white/10 text-sm font-semibold text-white">
