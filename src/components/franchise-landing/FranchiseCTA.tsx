        ...
        >
          ...
          <div className="relative p-12 rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              >
                Join 500+ successful franchise partners. Claim your exclusive territory 
                before it's taken.
              </motion.p>
              ...
              >
                <Button
                  ...
                  onClick={async () => {
                    await logAction({
                      action: 'public_franchise_apply_clicked',
                      ...
                      metadata: {
                        system_request: {
                          ...
                          payload_json: {
                            intent: 'apply',
                            entry_point: 'franchise_cta',
                            path: window.location.pathname,
                          },
                        },
                        status: 'pending',
                        source: 'franchise_cta',
                        path: window.location.pathname,
                      },
                    });
                    navigate('/apply?type=franchise');
                  }}
              ...
              >
                {['No Hidden Fees', 'Lifetime Access', '24/7 Support', 'AI Training Included'].map((badge, i) => (
